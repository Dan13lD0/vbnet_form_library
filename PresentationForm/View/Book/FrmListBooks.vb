Public Class FrmListBooks
    ...
    Private Function LoadGrid()
        Dim data = _bll.GetBooks(txtCode.Text, txtName.Text, cboCategory.SelectedValue, cboAuthor.SelectedValue, cboPublisher.SelectedValue, cboStatus.Text)
    ...
    Private Function FormatGrid()
        ...
        dgv.Columns("AuthorName").HeaderText = "Author"
        ...
        dgv.Columns("PublisherName").HeaderText = "Publisher"
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Dim frmNew As New FrmCreateUpdateBook("", "", "", "", "", "", "")
        frmNew.ShowDialog()
        LoadGrid()
    End Sub
    ...
    Private Sub dgv_DoubleClick(sender As Object, e As EventArgs) Handles dgv.DoubleClick
        If dgv.Rows.Count > 0 Then
            ...
            Dim frmUpdate As New FrmCreateUpdateBook(
            row.Cells("Id").Value.ToString(),
            row.Cells("Name").Value.ToString(), row.Cells("CategoryName").Value.ToString(),
